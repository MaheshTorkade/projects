...
void man(char *name)
{
    ...
    if(strcmp(name,"create")==0)
    {
        ...
        printf("Using:creat File_name Permission\n");
    }
    ...
    while(1)
    {
        ...
        else if(count==3)
        {
            if(strcmp(command[0],"create")==0)
            {
                ...
                if(ret>=0)
                    printf("File is successfully creat with file descripter:%d\n",ret);
                if(ret==-1)
                    printf("ERROR:Incorrect parameters\n");     
                if(ret==-2)
            ...
            else if(strcmp(command[0],"open")==0)
            {
                ...
                if(ret>=0)
                    printf("File is successfully open with file descripter:%d\n",ret);
                if(ret==-1)
                    printf("ERROR:Incorrect parameters\n");
                if(ret==-2)
